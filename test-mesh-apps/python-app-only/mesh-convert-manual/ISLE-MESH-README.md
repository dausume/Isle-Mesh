# mesh-convert-manual - Isle-Mesh Configuration
...
```bash
isle config set-project /home/dustin/Desktop/IsleMesh/test-mesh-apps/python-app-only/mesh-convert-manual
```
...
```bash
# On Linux
sudo cp ssl/certs/mesh-convert-manual.crt /usr/local/share/ca-certificates/
sudo update-ca-certificates

# On macOS
sudo security add-trusted-cert -d -r trustRoot -k /Library/Keychains/System.keychain ssl/certs/mesh-convert-manual.crt
```
...
- Base domain: https://mesh-app.local
- python-api: https://api.mesh-app.local
...
isle ssl info mesh-convert-manual   # Show certificate info
isle ssl verify mesh-convert-manual # Verify certificate
...
3. Verify DNS resolution: `ping mesh-app.local`

### SSL certificate errors
1. Ensure certificates are installed in system trust store
2. Check certificate validity: `isle ssl verify mesh-convert-manual`
...
Sun 26 Oct 2025 10:27:03 AM EDT
