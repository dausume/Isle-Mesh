...
analyze_compose() {
  echo "[2/7] Analyzing docker-compose file..."
...
setup_output_directory() {
  echo "[3/7] Setting up output directory..."
...
generate_ssl_config() {
  echo "[4/7] Generating SSL configuration..."
...
generate_proxy_config() {
  echo "[5/7] Generating proxy configuration..."
...
extract_env_config() {
  echo "[6/8] Extracting environment configuration..."
...
generate_mesh_compose() {
  echo "[8/8] Generating docker-compose.mesh-app.yml..."
...
generate_isle_mesh_yml() {
  echo "[9/9] Generating isle-mesh.yml..."
